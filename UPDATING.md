...
- [27930](https://github.com/apache/superset/pull/27930): Fixes the `config.py` file,Please fix the configuration item `USE-ANALAGOUS-COLORS`, and change it to `USE-ANALOGOUS-COLORS` due to a spelling mistake.
